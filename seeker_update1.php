...
<body class="limiter">
  ...
  <div class="wrapper">
    <div class="formcontainer">
      ...
      <form action="seeker_dashboard.php" style="margin:3%; padding:3%;" name="company_form" id="company_form"  method="POST" enctype="multipart/form-data" onsubmit="return passvalidation(event); return validateEmail(event);">
        <div class="form-section">
            <div class="imgcontainer" style=" z-index: 1;">
                <div class="form-top">
                <div class="form-left">
                <img src="<?php echo $profile_img; ?>" onerror="this.onerror=null; this.src='img/profile.png'" class="Profile" style="border-radius: 50px; height: 200px; width: 200px; margin-left: 50%; "><br><br>
                </div>
        ...
        <div class="form-section">
          ...
          <div class="form-bottom">
            <div class="form-left">
              ...
              <div>
                <label style="font-size:16px"><input type="checkbox">&nbsp;I accept all the <a href="#" onclick="showDoc('terms_and_conditions.pdf');">terms & conditions</a></label>
              </div>
            </div>
            <div class="form-right">
              <div>
...
define ('SITE_ROOT', realpath(dirname(__FILE__)));
    ...
    cgpa='$cgpa', password='$password', profile_img='$profile_img' where id=$id");
