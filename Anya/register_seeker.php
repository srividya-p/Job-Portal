...
<div class="wrapper">
  ...
  <div class="formcontainer">
      ...
      <form id="registerSeeker" method="POST" action="action_seeker.php" name="SeekerRegistration" class="registerSeeker" onsubmit="return passvalidation(event); return validateEmail(event);">   
          <div class="form-section"> 
              <p class="sub-head"> Personal details </p>
                <div class="form-top">
                  <div class="form-left">
                    ...
                    <div>
                      <input class="form-control" type="text" id="email" name="email" placeholder="Email * (abc@example.com)" onchange="return validateEmail(event);" required >
                    </div>
                    <div>
                      <textarea class="form-control" rows="4" id="aboutme" name="aboutme" placeholder="Brief intro about yourself"></textarea>
                    </div>
                    <div>
                    ...
                    <div>
                      <input class="form-control" type="text" id="age" name="age" placeholder="Age" value="" readonly>
                    </div>  
                  </div>
                  <div class="form-right">
                    ...
                    <div>
                      <input class="form-control" type="text" id="contactno" name="contactno" minlength="10" maxlength="10" style=" " onkeypress="return validatePhone(event);" 
                      placeholder="Phone Number *"required>
                    </div>
                    <div>
                      <textarea style="height:132px" class="form-control" rows="4" id="address" name="address" placeholder="Address"></textarea>
                    </div>
                    <div>
              ...
              <p class="sub-head"> Education details </p>
                <div class="form-bottom">
                  ...
                  <div class="form-right">
                    <div>
                      <textarea style="margin-top:35px" class="form-control" rows="4" id="skills" name="skills" placeholder="Enter Skills"></textarea>
                    </div>              
                    <div>
