...
<div class="sidenav">
  ...
  <a href="admin_job_seeker.php" class="active"><i class="fa fa-fw fa-table"></i> Job Seeker</a>
...
<div class="main">
  <div id="page-wrapper">
                ...
                <div class="row">
                    <h1 class="page-header" style="font-size: 25px; padding-top: 25px;"> Registered Users
                    </h1>
                  </div>
                  <br>
                  ...
                  <div>
                    ...
                    <table style="margin: 20px;">
                      ...
                      <tr>
                        ...
                        <td>Gupta</td>
                        <td>20</td>
                        <td><button style="padding: 5px 15px 5px 15px; font-size: 20px;background-color: #F7BBA6 ; align-content: center;">Resume</button></td>
                      </tr>
                    </table>
                  </div>
