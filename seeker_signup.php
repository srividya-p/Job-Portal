...
<div class="wrapper">
  ...
  <div class="formcontainer">
      ...
      <form id="registerSeeker" method="post" action="seeker_signup.php" name="SeekerRegistration"
              ...
              <p class="sub-head"> Personal details </p>
                <div class="form-top">
                  ...
                  <div class="form-right">
                    ...
                    <div>
                      <input class="form-control" type="number" id="mobileno" name="mobileno" minlength="10" maxlength="10" style=" " onkeypress="return validatePhone(event);" 
